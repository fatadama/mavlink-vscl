...
static void mavlink_test_vscl_controls(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_vscl_controls_t packet_in = {
		17235,
	17339,
	17443,
	17547,
	};
	mavlink_vscl_controls_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.elev = packet_in.elev;
        	packet1.thro = packet_in.thro;
        	packet1.aile = packet_in.aile;
        	packet1.rudd = packet_in.rudd;
        
        

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vscl_controls_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_vscl_controls_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vscl_controls_pack(system_id, component_id, &msg , packet1.elev , packet1.thro , packet1.aile , packet1.rudd );
	mavlink_msg_vscl_controls_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vscl_controls_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.elev , packet1.thro , packet1.aile , packet1.rudd );
	mavlink_msg_vscl_controls_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_vscl_controls_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vscl_controls_send(MAVLINK_COMM_1 , packet1.elev , packet1.thro , packet1.aile , packet1.rudd );
	mavlink_msg_vscl_controls_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_vscl_autoland(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	...
	mavlink_vscl_autoland_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	...
        	packet1.gamm = packet_in.gamm;
        	packet1.lambd = packet_in.lambd;
        	packet1.psi = packet_in.psi;
        	packet1.theta = packet_in.theta;
        	packet1.phi = packet_in.phi;
        	packet1.elev = packet_in.elev;
        	packet1.thto = packet_in.thto;
        	packet1.aile = packet_in.aile;
        
        

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vscl_autoland_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_vscl_autoland_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vscl_autoland_pack(system_id, component_id, &msg , packet1.time , packet1.gamm , packet1.lambd , packet1.psi , packet1.theta , packet1.phi , packet1.elev , packet1.thto , packet1.aile );
	mavlink_msg_vscl_autoland_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vscl_autoland_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time , packet1.gamm , packet1.lambd , packet1.psi , packet1.theta , packet1.phi , packet1.elev , packet1.thto , packet1.aile );
	mavlink_msg_vscl_autoland_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_vscl_autoland_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vscl_autoland_send(MAVLINK_COMM_1 , packet1.time , packet1.gamm , packet1.lambd , packet1.psi , packet1.theta , packet1.phi , packet1.elev , packet1.thto , packet1.aile );
	mavlink_msg_vscl_autoland_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_diagnostic(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_msg_diagnostic_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_diagnostic_pack(system_id, component_id, &msg , packet1.val1 , packet1.val2 , packet1.val3 , packet1.val4 , packet1.val5 );
	mavlink_msg_diagnostic_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_diagnostic_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.val1 , packet1.val2 , packet1.val3 , packet1.val4 , packet1.val5 );
	mavlink_msg_diagnostic_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_diagnostic_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_diagnostic_send(MAVLINK_COMM_1 , packet1.val1 , packet1.val2 , packet1.val3 , packet1.val4 , packet1.val5 );
	mavlink_msg_diagnostic_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_ardupilotmega(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_test_vscl_controls(system_id, component_id, last_msg);
	mavlink_test_vscl_autoland(system_id, component_id, last_msg);
