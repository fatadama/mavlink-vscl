...
Generated from: vscl.xml,ardupilotmega.xml,common.xml
...
class MAVLink_vscl_test_message(MAVLink_message):
        '''
        This message does nothing but cconfirm GS-to-vehicle
...
class MAVLink(object):
        ...
        def vscl_test_encode(self, dummy):
                '''
                This message does nothing but cconfirm GS-to-vehicle communication w/
                custom MAV commands.
