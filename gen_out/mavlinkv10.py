...
class MAVLink_vscl_autoland_message(MAVLink_message):
        ...
        commanded values).
        '''
        def __init__(self, time, gamm, lambd, psi, theta, phi, elev, thto, aile):
                MAVLink_message.__init__(self, MAVLINK_MSG_ID_VSCL_AUTOLAND, 'VSCL_AUTOLAND')
                self._fieldnames = ['time', 'gamm', 'lambd', 'psi', 'theta', 'phi', 'elev', 'thto', 'aile']
                self.time = time
                self.gamm = gamm
                self.lambd = lambd
                self.psi = psi
...
class MAVLink(object):
        ...
        def vscl_autoland_encode(self, time, gamm, lambd, psi, theta, phi, elev, thto, aile):
                '''
        ...
        def vscl_autoland_send(self, time, gamm, lambd, psi, theta, phi, elev, thto, aile):
                '''
                Send the current autolanding controller state (reference and commanded
                values).
