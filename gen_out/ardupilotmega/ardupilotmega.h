...
#include "./mavlink_msg_vscl_test.h"
#include "./mavlink_msg_vscl_bump.h"
#include "./mavlink_msg_vscl_controls.h"
#include "./mavlink_msg_vscl_autoland.h"
