...
typedef struct __mavlink_vscl_autoland_t
{
 ...
 int32_t psi; ///< Reference heading (10-4 rad).
 int32_t theta; ///< Reference pitch (10-4 rad).
 int32_t phi; ///< Reference bank (10-4 rad).
 int32_t elev; ///< Elevator setting (cd).
 int32_t thto; ///< Throttle setting (pct?).
 int32_t aile; ///< Aileron setting (cd).
} mavlink_vscl_autoland_t;

#define MAVLINK_MSG_ID_VSCL_AUTOLAND_LEN 36
#define MAVLINK_MSG_ID_203_LEN 36
...
#define MAVLINK_MESSAGE_INFO_VSCL_AUTOLAND { \
	...
	{  { "time", NULL, MAVLINK_TYPE_INT32_T, 0, 0, offsetof(mavlink_vscl_autoland_t, time) }, \
         ...
         { "psi", NULL, MAVLINK_TYPE_INT32_T, 0, 12, offsetof(mavlink_vscl_autoland_t, psi) }, \
         { "theta", NULL, MAVLINK_TYPE_INT32_T, 0, 16, offsetof(mavlink_vscl_autoland_t, theta) }, \
         { "phi", NULL, MAVLINK_TYPE_INT32_T, 0, 20, offsetof(mavlink_vscl_autoland_t, phi) }, \
         { "elev", NULL, MAVLINK_TYPE_INT32_T, 0, 24, offsetof(mavlink_vscl_autoland_t, elev) }, \
         { "thto", NULL, MAVLINK_TYPE_INT32_T, 0, 28, offsetof(mavlink_vscl_autoland_t, thto) }, \
         { "aile", NULL, MAVLINK_TYPE_INT32_T, 0, 32, offsetof(mavlink_vscl_autoland_t, aile) }, \
         } \
}
...
static inline uint16_t mavlink_msg_vscl_autoland_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       int32_t time, int32_t gamm, int32_t lambd, int32_t psi, int32_t theta, int32_t phi, int32_t elev, int32_t thto, int32_t aile)
{
	...
	_mav_put_int32_t(buf, 12, psi);
	_mav_put_int32_t(buf, 16, theta);
	_mav_put_int32_t(buf, 20, phi);
	_mav_put_int32_t(buf, 24, elev);
	_mav_put_int32_t(buf, 28, thto);
	_mav_put_int32_t(buf, 32, aile);
	...
	return mavlink_finalize_message(msg, system_id, component_id, 36, 105);
}
						           ...
						           int32_t time,int32_t gamm,int32_t lambd,int32_t psi,int32_t theta,int32_t phi,int32_t elev,int32_t thto,int32_t aile)
{
	...
	msg->msgid = MAVLINK_MSG_ID_VSCL_AUTOLAND;
	return mavlink_finalize_message_chan(msg, system_id, component_id, chan, 36, 105);
}
...
static inline void mavlink_msg_vscl_autoland_send(mavlink_channel_t chan, int32_t time, int32_t gamm, int32_t lambd, int32_t psi, int32_t theta, int32_t phi, int32_t elev, int32_t thto, int32_t aile)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[36];
	_mav_put_int32_t(buf, 0, time);
	...
	_mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_VSCL_AUTOLAND, buf, 36, 105);
#else
	mavlink_vscl_autoland_t packet;
	packet.time = time;
	packet.gamm = gamm;
	...
	_mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_VSCL_AUTOLAND, (const char *)&packet, 36, 105);
#endif
}
 ...
 */
static inline int32_t mavlink_msg_vscl_autoland_get_psi(const mavlink_message_t* msg)
{
 ...
 */
static inline int32_t mavlink_msg_vscl_autoland_get_theta(const mavlink_message_t* msg)
{
 ...
 */
static inline int32_t mavlink_msg_vscl_autoland_get_phi(const mavlink_message_t* msg)
{
 ...
 */
static inline int32_t mavlink_msg_vscl_autoland_get_elev(const mavlink_message_t* msg)
{
 ...
 */
static inline int32_t mavlink_msg_vscl_autoland_get_thto(const mavlink_message_t* msg)
{
 ...
 */
static inline int32_t mavlink_msg_vscl_autoland_get_aile(const mavlink_message_t* msg)
{
...
#else
	memcpy(vscl_autoland, _MAV_PAYLOAD(msg), 36);
#endif
}
